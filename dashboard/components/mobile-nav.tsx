...
const NAV: { href: string; label: string; icon: React.ComponentType<{ className?: string }>; target?: string }[] = [
  ...
  { href: "/catalog", label: "🌐 კატალოგი", icon: Globe, target: "_blank" as const },
];
