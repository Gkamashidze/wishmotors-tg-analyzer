...
**Stock topic-ში:** Excel (.xlsx) ფაილი სვეტებით: `სახელი | OEM | მარაგი | ფასი | თარიღი`

> სვეტი **თარიღი** (მე-5) — სავალდებულო არ არის. თუ მითითებულია (მაგ: `2026-02-15`), სისტემა ჩანაწერს ამ თარიღით შეინახავს (backdate). მხარდაჭერილი ფორმატები: `YYYY-MM-DD`, `DD.MM.YYYY`, `DD/MM/YYYY`.
